# A0115333U
###### \main\java\seedu\address\logic\commands\ListAllCommand.java
``` java
...
```
###### \main\java\seedu\address\logic\commands\ListCompletedCommand.java
``` java
package seedu.address.logic.commands;
...
```
###### \main\java\seedu\address\logic\commands\ListOngoingCommand.java
``` java
package seedu.address.logic.commands;
...
```
###### \main\java\seedu\address\logic\commands\SetPathCommand.java
``` java
package seedu.address.logic.commands;
...
```
###### \main\java\seedu\address\logic\parser\SetPathCommandParser.java
``` java
